...
from src.services.menu_runtime_fields import (
    COMPONENT_FIELD_EDIT_CONFIG,
    ITEM_ENUM_ACTIONS,
    ITEM_FIELD_EDIT_CONFIG,
    SPELL_FIELD_EDIT_CONFIG,
)
from src.ui.menu_functions import Menu

if TYPE_CHECKING:
    import discord

    from src.services.menu_runtime_service import MenuInterface, MenuRuntimeService, OriginalMessage
