...
class CombatSimulatorFrame(ttk.Frame):
    ...
    def _edit_attributes(self, side_key: str):
        ...
        from src.tools.admin_gui import AttributesEditorDialog
    ...
    def _edit_gear(self, side_key: str):
        ...
        from src.tools.admin_gui import GearEditorDialog
    ...
    def _edit_buffs(self, side_key: str):
        ...
        from src.tools.admin_gui import BonusEditorDialog
